...
private:
  ...
  const char *hlt_name[nHLTmx] = {"HLT_IsoMu24_v","HLT_Mu50_v",  // single-muon triggers
				  ...
				  "HLT_TkMu50_v",   //one more muon trigger for 2016
				  "HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL","HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL","HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ","HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ" //emu triggers for 2016 & 2017
  }; 
  ...
  hltPrescaleProvider_(pset, consumesCollector(), *this)  
{
  ...
  T1->Branch("hlt_HT800",&hlt_HT800,"hlt_HT800/O");
  T1->Branch("hlt_HT900",&hlt_HT900,"hlt_HT900/O");
...
Leptop::analyze(const edm::Event& iEvent, const edm::EventSetup& pset) {
  ...
  for(int jk=0; jk<nHLTmx; jk++) {
      ...
      else if(jk==21) {  hlt_IsoMu27 = booltrg[jk]; }
	  else if(jk==22) {  hlt_TkMu100 = booltrg[jk]; }
	  else if(jk==23) {  hlt_OldMu100 = booltrg[jk]; }
	  else if(jk==24) {  hlt_Ele32_WPTight_Gsf_L1DoubleEG = booltrg[jk]; }
	  else if(jk==25) {  hlt_Ele35_WPTight_Gsf = booltrg[jk]; }
	  else if(jk==26) {  hlt_DoubleEle33_CaloIdL_MW = booltrg[jk]; }
	  else if(jk==27) {  hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 = booltrg[jk]; }
      else if(jk==28) {  hlt_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8   = booltrg[jk]; }
      //
      else if(jk==29) {  hlt_IsoTkMu24   = booltrg[jk]; }
      else if(jk==30) {  hlt_Ele27_WPTight_Gsf   = booltrg[jk]; }
      else if(jk==31) {  hlt_AK8PFJet450   = booltrg[jk]; }
      ...
      //
      else if(jk==43) {  hlt_TkMu50 = booltrg[jk]; }
      //
      else if(jk==44) {  hlt_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL = booltrg[jk]; }
      else if(jk==45) {  hlt_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL = booltrg[jk]; }
      else if(jk==46) {  hlt_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ = booltrg[jk]; }
      else if(jk==47) {  hlt_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ = booltrg[jk]; }
