...
config.General.requestName = 'crab_XtoYH_UL2018_TT_Dilep'
config.General.workArea = 'crab_XtoYH_UL2018_TT_Dilep'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_TT_Dilep'
