...
config.General.requestName = 'crab_XtoYH_UL2018_WZTo3LNu'
config.General.workArea = 'crab_XtoYH_UL2018_WZTo3LNu'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_WZTo3LNu'
