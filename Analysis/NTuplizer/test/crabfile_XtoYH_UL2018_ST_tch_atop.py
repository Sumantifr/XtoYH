...
config.General.requestName = 'crab_XtoYH_UL2018_ST_tch_atop'
config.General.workArea = 'crab_XtoYH_UL2018_ST_tch_atop'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_ST_tch_atop'
