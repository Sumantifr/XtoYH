...
config.General.requestName = 'crab_XtoYH_UL2018_RunC_SingleMuon'
config.General.workArea = 'crab_XtoYH_UL2018_RunC_SingleMuon'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'RunJets_Data_2018C_MINIAOD_cfg.py'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_RunC_SingleMuon'
