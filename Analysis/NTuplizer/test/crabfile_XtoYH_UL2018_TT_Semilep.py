...
config.General.requestName = 'crab_XtoYH_UL2018_TT_Semilep'
config.General.workArea = 'crab_XtoYH_UL2018_TT_Semilep'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_TT_Semilep'
