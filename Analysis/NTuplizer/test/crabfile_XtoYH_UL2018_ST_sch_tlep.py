...
config.General.requestName = 'crab_XtoYH_UL2018_ST_sch_tlep'
config.General.workArea = 'crab_XtoYH_UL2018_ST_sch_tlep'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_ST_sch_tlep'
