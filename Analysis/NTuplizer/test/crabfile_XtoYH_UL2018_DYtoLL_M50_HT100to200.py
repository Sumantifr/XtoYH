...
config.General.requestName = 'crab_XtoYH_UL2018_DYtoLL_M50_HT100to200'
config.General.workArea = 'crab_XtoYH_UL2018_DYtoLL_M50_HT100to200'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_DYtoLL_M50_HT100to200'
