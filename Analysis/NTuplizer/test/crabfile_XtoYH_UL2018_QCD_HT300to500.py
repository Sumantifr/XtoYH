...
config.General.requestName = 'crab_XtoYH_UL2018_QCD_HT300to500'
config.General.workArea = 'crab_XtoYH_UL2018_QCD_HT300to500'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_QCD_HT300to500'
