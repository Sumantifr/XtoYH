...
config.General.requestName = 'crab_XtoYH_UL2018_RunB_EGamma'
config.General.workArea = 'crab_XtoYH_UL2018_RunB_EGamma'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_RunB_EGamma'
