...
config.General.requestName = 'crab_XtoYH_UL2018_RunA_SingleMuon'
config.General.workArea = 'crab_XtoYH_UL2018_RunA_SingleMuon'
...
config.Data.outputDatasetTag = 'XtoYH_UL2018_RunA_SingleMuon'
