...
TH1F* get_histo_symbin_II(TString Y_op_name, TString W_op_name, TString reg_name, TString bcat_name, TString Wops_name, string var, string addText, int nbins, float low_edge, float up_edge)
{
char name[500];
sprintf(name,"h_Y_%s_W_%s_%s_%s_%s%s%s",Y_op_name.Data(),W_op_name.Data(),var.c_str(),Wops_name.Data(),reg_name.Data(),bcat_name.Data(),addText.c_str());
TH1F *hout = new TH1F(name, "",nbins,low_edge,up_edge);
hout->Sumw2();
return hout;
}
...
////
  ...
  Bool_t          PFJetAK8_label_Top_bq[njetmx];   //[_s_nPFJetAK8]
  Bool_t          PFJetAK8_label_Top_bc[njetmx];   //[_s_nPFJetAK8]
  Bool_t          PFJetAK8_label_Top_bcq[njetmx];   //[_s_nPFJetAK8]
  Bool_t          PFJetAK8_label_Top_bqq[njetmx];   //[_s_nPFJetAK8]
  Bool_t          PFJetAK8_label_W_qq[njetmx];   //[_s_nPFJetAK8]
  Bool_t          PFJetAK8_label_W_cq[njetmx];   //[_s_nPFJetAK8]
  ...
  Bool_t          JetAK4_isMediumBJet[njetmx];   //[_s_nJetAK4]
  Bool_t          JetAK4_isLooseBJet[njetmx];   //[_s_nJetAK4]
  ...
  Int_t           nMuon;
  Float_t         Muon_pt[njetmx];   //[_s_nMuon]
  Float_t         Muon_eta[njetmx];   //[_s_nMuon]
  Float_t         Muon_phi[njetmx];   //[_s_nMuon]
  Float_t         Muon_mass[njetmx];   //[_s_nMuon]
  Int_t           Muon_ID[njetmx];   //[_s_nMuon]
  Float_t         Muon_minisoall[njetmx];   //[_s_nMuon]
  Float_t         Muon_pfiso[njetmx];   //[_s_nMuon]
  
  Int_t           nElectron;
  Float_t         Electron_pt[njetmx];   //[_s_nElectron]
  Float_t         Electron_eta[njetmx];   //[_s_nElectron]
  Float_t         Electron_phi[njetmx];   //[_s_nElectron]
  Float_t         Electron_mass[njetmx];   //[_s_nElectron]
  Bool_t          Electron_Fallv2WP90_noIso[njetmx];   //[_s_nElectron]
  Bool_t          Electron_Fallv2WP80_noIso[njetmx];   //[_s_nElectron]
  Bool_t          Electron_Fallv2WP90[njetmx];   //[_s_nElectron]
  Bool_t          Electron_Fallv2WP80[njetmx];   //[_s_nElectron]
  Float_t         Electron_minisoall[njetmx];   //[_s_nElectron]
  Float_t         Electron_pfiso_eacor[njetmx];   //[_s_nElectron]
  ...
  TString sysnames[] = {
	 ...
	 "JES_Total",
	 "JER",
	 "PU","LeptonSF","LeptonSF2","Prefire","BTG","TrigSF1","TrigSF2"}; 
  ...
  void read_branches(TTree *tree, bool isDL=false)
  {
   ...
   tree->SetBranchAddress("PFJetAK8_label_Top_bq", PFJetAK8_label_Top_bq);
   tree->SetBranchAddress("PFJetAK8_label_Top_bc", PFJetAK8_label_Top_bc);
   tree->SetBranchAddress("PFJetAK8_label_Top_bcq", PFJetAK8_label_Top_bcq);
   tree->SetBranchAddress("PFJetAK8_label_Top_bqq", PFJetAK8_label_Top_bqq);
   tree->SetBranchAddress("PFJetAK8_label_W_qq", PFJetAK8_label_W_qq);
   tree->SetBranchAddress("PFJetAK8_label_W_cq", PFJetAK8_label_W_cq);
   tree->SetBranchAddress("PFJetAK8_JESup_split", &PFJetAK8_JESup_split);
   tree->SetBranchAddress("PFJetAK8_JESdn_split", &PFJetAK8_JESdn_split);
   ...
   tree->SetBranchAddress("JetAK4_isMediumBJet", JetAK4_isMediumBJet);
   tree->SetBranchAddress("JetAK4_isLooseBJet", JetAK4_isLooseBJet);
   ...
   tree->SetBranchAddress("JetAK4_JESup_split", &JetAK4_JESup_split);
   tree->SetBranchAddress("JetAK4_JESdn_split", &JetAK4_JESdn_split),
   ...
   tree->SetBranchAddress("Muon_minisoall", Muon_minisoall);
   ...
   tree->SetBranchAddress("Electron_Fallv2WP90_noIso", Electron_Fallv2WP90_noIso);
   tree->SetBranchAddress("Electron_Fallv2WP80_noIso", Electron_Fallv2WP80_noIso);
   tree->SetBranchAddress("Electron_Fallv2WP90", Electron_Fallv2WP90);
   tree->SetBranchAddress("Electron_Fallv2WP80", Electron_Fallv2WP80);
   tree->SetBranchAddress("Electron_minisoall", Electron_minisoall);
   tree->SetBranchAddress("Electron_pfiso_eacor", Electron_pfiso_eacor);
