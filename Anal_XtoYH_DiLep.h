...
#include "Objects.h"
   ...
   float l_pt[2], l_eta[2], l_phi[2], l_mass[2];
   int l_pdgId[2];
   float l_minisoch[2], l_minisonh[2], l_minisoph[2], l_minisoall[2]; 
   int l_genindex[2];
...
*/
   float dR_lY[2], dphi_lY[2], dy_lY[2];
   int nbjets_other, nbjets_outY, nbjets_outY_L, nbjets, nbjets_L;
   
   float l1l2_mass, l1l2_dR, l1l2_deta, l1l2_dphi;
   float dphi_MET_l1l2;
   
   float HTlep_pt, HTlep_pt_JES_up, HTlep_pt_JES_dn, HTlep_pt_JER_up, HTlep_pt_JER_dn;
   float ST, ST_JES_up, ST_JES_dn, ST_JER_up, ST_JER_dn;
