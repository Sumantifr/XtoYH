...
argParser.add_argument('--isDATA',          action='store',      default=False, type=bool,             help = "WC value")
argParser.add_argument('--isSignal',          action='store',      default=False, type=bool,             help = "WC value")
...
pass_fracs = [1./data_sample['pass'] for data_sample in data_crab_info]
data_names = [data_sample['name'] for data_sample in data_crab_info]
...
if args.isDATA:
    os.system("./haddws.exe "+sample_directory+"/Histogram_EGamma_UL2018A_XtoYH_Nov_2021.root "+sample_directory+"/Histogram_EGamma_UL2018B_XtoYH_Nov_2021.root " +sample_directory+"/Histogram_EGamma_UL2018C_XtoYH_Nov_2021.root " +sample_directory+"/Histogram_EGamma_UL2018D_XtoYH_Nov_2021.root "+float_to_str(pass_fracs[data_names.index('EGamma_RunA')])+" "+float_to_str(pass_fracs[data_names.index('EGamma_RunB')])+" "+float_to_str(pass_fracs[data_names.index('EGamma_RunC')])+" "+float_to_str(pass_fracs[data_names.index('EGamma_RunD')]))
    os.system("mv result.root "+sample_directory+"/Histogram_EGamma_UL2018.root")
	...
	os.system("mv result.root "+sample_directory+"/Histogram_SingleMuon_UL2018.root")
	os.system("./haddws.exe "+sample_directory+"/Histogram_JetHT_UL2018A_XtoYH_Nov_2021.root "+sample_directory+"/Histogram_JetHT_UL2018B_XtoYH_Nov_2021.root " +sample_directory+"/Histogram_JetHT_UL2018C_XtoYH_Nov_2021.root " +sample_directory+"/Histogram_JetHT_UL2018D_XtoYH_Nov_2021.root "+float_to_str(pass_fracs[data_names.index('JetHT_RunA')])+" "+float_to_str(pass_fracs[data_names.index('JetHT_RunB')])+" "+float_to_str(pass_fracs[data_names.index('JetHT_RunC')])+" "+float_to_str(pass_fracs[data_names.index('JetHT_RunD')]))
	os.system("mv result.root "+sample_directory+"/Histogram_JetHT_UL2018.root")
